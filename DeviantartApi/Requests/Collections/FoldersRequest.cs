...
{
    public class FoldersRequest : PageableRequest<Objects.ArrayOfResults<Objects.SubObjects.CollectonFolder>>
    {
        ...
        public override async Task<Response<Objects.ArrayOfResults<Objects.SubObjects.CollectonFolder>>> ExecuteAsync()
        {
